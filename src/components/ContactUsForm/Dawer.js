...
const ContactUsForm = () => {
  ...
  //     } else {
  //       setErrorMessage(formatMessage({ id: "formErrorMessage" }));
  ...
  const onSubmit = (data) => {
    ...
    // استخدام fetch لإرسال البيانات إلى PHP
    fetch("./sendMail.php", {
      method: "POST",
      headers: {
    ...
    <ScrollableAnchor id="Contact-Us">
      <section className="py-16 md:px-2">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 gap-8 bg-gradient-to-r from-primary-900 to-primary-700 xsm:rounded-3xl md:grid-cols-2">
            {/* نموذج التواصل */}
              ...
              <form className="md:text-start" onSubmit={handleSubmit(onSubmit)}>
                <div className="mb-4">
                  <input
                    ...
                    {...register("name", {
                      required: formatMessage({ id: "nameRequiredMessage" }),
                    })}
                  />
                  {errors.name && (
                ...
                <div className="mb-4">
                  <input
                    ...
                    {...register("email", {
                      required: formatMessage({ id: "emailRequiredMessage" }),
                      pattern: {
                        value: /^\S+@\S+$/i,
                        message: formatMessage({ id: "emailInvalidMessage" }),
                      },
                    })}
                  />
                  {errors.email && (
                ...
                <div className="mb-4">
                  <input
                    ...
                    {...register("phoneNumber", {
                      required: formatMessage({ id: "phoneRequiredMessage" }),
                      pattern: {
                        value: /^[0-9]+$/i,
                        message: formatMessage({ id: "phoneInvalidMessage" }),
                      },
                      minLength: {
                        value: 8,
                        message: formatMessage({ id: "phoneMinLengthMessage" }),
                      },
                    })}
                  />
                  {errors.phoneNumber && (
                ...
                <div className="mb-4">
                  <textarea
                    placeholder={formatMessage({
                      id: "contactUsMessagePlaceholder",
                    })}
                    ...
                    {...register("message", {
                      required: formatMessage({ id: "messageRequiredMessage" }),
                    })}
                  />
                  {errors.message && (
            ...
            {/* معلومات التواصل */}
            <div className="flex flex-col justify-center bg-primary-900 px-6 py-12 text-center text-white bg-blend-overlay xsm:rounded-b-3xl md:rounded-l-3xl md:px-8 md:text-start lg:px-14">
              <h2 className="mb-4 text-3xl font-bold text-primary-50 md:text-4xl">
                {formatMessage({ id: "contactInfoTitle" })}
              </h2>
              <p className="mb-6 text-base text-primary-200">
                {formatMessage({ id: "contactInfoDescription" })}
              </p>
              <Image
                src={"/images/bar.webp"}
                alt="divider"
              ...
              <div className="mb-4">
                <a
                  ...
                  className="flex items-center justify-center py-2 font-en font-bold text-primary-100 md:justify-start"
                >
                  {emailIcon}
                  {contactInfo.email}
                </a>
                <a
                  ...
                  className="flex items-center justify-center py-2 text-lg font-bold text-primary-100 md:justify-start"
                >
                  {phoneIcon} <span dir="ltr"> {contactInfo.phoneView}</span>
                </a>
              </div>
              <Image
                src={"/images/bar.webp"}
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70">
              <div className="rounded-lg bg-white p-6 shadow-lg">
                <h2 className="text-xl font-bold text-red-500">
                  {formatMessage({ id: "errorTitle" })}
                </h2>
                <p className="mt-4">{errorMessage}</p>
                <p className="mt-4">
                  {formatMessage({ id: "errorMessageDescription" })}
                </p>
                <button
                ...
                >
                  {formatMessage({ id: "contactViaWhatsApp" })}
                </a>
              </div>
            </div>
          </>
