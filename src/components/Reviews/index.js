    ...
    <div className="section-gab-top container" id="reviews">
      <div className={style.reviews}>
        <div className={style.titleBox}>
          <h2 className={style.reviewsTitle}>{formatMessage({ id: 'reviewsTitle' })}</h2>
              ...
              <SwiperSlide key={review.id}>
                <div className={style.review__container}>
                  <Image
                    ...
                    alt="quote"
                  />
                  <p className={style.review__paragraph}>{review.description}</p>
                  <div>
                    <div className={style.review__reviewcontainer}>
                      <div className={style.review__imagecontainer}>
                        <Image className='img-fluid h-100' src={`/images/reviews/${review.logourl}`} width={review.width} height={review.height} alt={review.name} />
                      </div>
                      <div className={style.review__nameContainer}>
                        <span className={style.review__name}>{review.name}</span>
                        <span className={style.review__position}>{review.position}</span>
                      </div>
                    </div>
                  </div>
                </div>
